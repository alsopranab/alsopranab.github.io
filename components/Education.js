                    ...
                    <div className="card border-l-4 border-l-[var(--primary-color)]">
                        ...
                        <div className="mt-6 pt-4 border-t border-gray-50">
                            ...
                            <p className="text-sm text-gray-600 font-light leading-relaxed">
                                Airway & Tracheostomy Care, Emergency Medication Administration (EMA),
                                IV Therapy & Monitoring, Assistance in Surgical & Clinical Procedures
                                (including lithotomy positioning)
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="flex gap-3">
                                ...
                                <div>
                                    <h4 className="font-medium text-gray-800 text-sm">
                                        Professional Certificate in SQL for Data Analysis
                                    </h4>
                                    <p className="text-xs text-gray-500">
                                        Udemy
                                    </p>

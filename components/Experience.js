    ...
    return (
        <section id="experience" className="section-padding relative overflow-hidden" data-name="experience" data-file="components/Experience.js">
            ...
            <div className="relative max-w-4xl mx-auto">
                ...
                <div className="absolute left-4 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-500/0 via-purple-500 to-blue-500/0 md:hidden"></div>
                        ...
                        <div key={idx} className={`flex flex-col md:flex-row gap-8 items-center ${idx % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                            <div className="flex-1 w-full pl-10 md:pl-0">
                                <div className="card glass-panel p-6 transform hover:scale-[1.02] transition-all duration-300 border-l-4 border-l-purple-500">
                                    <span className="text-xs font-mono text-purple-400 mb-2 block">{exp.period}</span>
                                    <h3 className="text-xl font-bold text-white mb-1">{exp.role}</h3>
                                    <div className="text-slate-400 text-sm font-medium mb-3">{exp.company}</div>

                    ...
                    <div className="ml-10 relative">
                        ...
                        <div className="card py-6 px-8 border-l-4 border-l-[var(--primary-color)]">
                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-baseline mb-1">
                                ...
                                <span className="text-xs text-gray-400 font-light uppercase tracking-wider">Jan 2025 - Dec 2025</span>
                            </div>
                    ...
                    <div className="ml-10 relative">
                        ...
                        <div className="card py-6 px-8 border-l-4 border-l-[var(--primary-color)]">
                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-baseline mb-1">
                                ...
                                <span className="text-xs text-gray-400 font-light uppercase tracking-wider">Oct 2024 - Dec 2025</span>
                            </div>

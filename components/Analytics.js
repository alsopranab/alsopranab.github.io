    ...
    React.useEffect(() => {
        const fetchGithubStats = async () => {
            try {
                ...
                const eventsRes = await fetch(`https://proxy-api.trickle-app.host/?url=https://api.github.com/repos/alsopranab/${repo.name}/commits?per_page=100`);
    ...
    return (
        <div className="space-y-10" data-name="Analytics" data-file="components/Analytics.js">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* Commit Trend Chart - Gray Theme matching reference */}
